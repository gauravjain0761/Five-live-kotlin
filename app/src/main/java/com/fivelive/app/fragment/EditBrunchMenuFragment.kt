...
class EditBrunchMenuFragment : Fragment(), RecyclerViewClickListener {
    private val TYPE = "4"
    ...
    fun setDataInList() {
        editHappyHourMenuAdapter =
            EditHappyHourMenuAdapter(requireContext(), hhMenuList!!.toMutableList(), this, this@EditBrunchMenuFragment)
    ...
    companion object {
        const val TAG = "EditBrunchMenuFragment"
    }
}