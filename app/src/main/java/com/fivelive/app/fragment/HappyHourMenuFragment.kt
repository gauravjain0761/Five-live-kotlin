...
class HappyHourMenuFragment : Fragment(), RecyclerViewClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_happy_hour_menu, container, false)
    }
    ...
    fun setDataInList() {
        editHappyHourMenuAdapter =
            EditHappyHourMenuAdapter(requireContext(), hhMenuList!!.toMutableList(), this, this@HappyHourMenuFragment)
    ...
    /*when we add menu for happy hours we are Setting in type = 2*/
    ...
    companion object {
        const val TAG = "HappyHourMenuFragment"
        const val TYPE = "2"
    }
}