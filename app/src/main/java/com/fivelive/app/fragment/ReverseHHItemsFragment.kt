...
class ReverseHHItemsFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_reverse_happy_hours_items, container, false)
    }
    ...
    private fun dispatchToHHAddItemActivity() {
        ...
        intent.putExtra(AppConstant.FROM, SetReverseHappyHourActivity.TAG)
    ...
    fun setDataOnList() {
        ...
        stringList.add("Reverse Happy Hour Drink Menu")
        stringList.add("Reverse Happy Hour Food Menu")
    ...
    companion object {
        const val TAG = "ReverseHHItemsFragment"
    }
}