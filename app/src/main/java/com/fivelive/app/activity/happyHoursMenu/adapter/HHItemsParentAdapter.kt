...
class HHItemsParentAdapter(var context: Context?, var categoryArrayList: List<Category>?) :
    RecyclerView.Adapter<HHItemsParentAdapter.MyViewHolder>() {
    ...
    fun setDataOnList(holder: MyViewHolder, categoryDataList: List<CategoryData>) {
        val adapter = HHItemsChildAdapter(context, categoryDataList)
