...
class BusinessReverseHHDetailsFragment : Fragment() {
    var recyclerView: RecyclerView? = null
    var reverseHHDetailsArrayList: ArrayList<HHDetails>? = null
    override fun onCreateView(
        ...
        reverseHHDetailsArrayList = bundle!!.getParcelableArrayList(AppConstant.DETAILS_LIST)
    ...
    fun setDataOnList() {
        val adapter = BusinessHHDetailsAdapter(activity, reverseHHDetailsArrayList)
