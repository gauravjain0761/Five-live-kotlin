...
class BusinessHHDetailsAdapter(var context: Context?, var hhDetailsArrayList: List<HHDetails>?) :
    RecyclerView.Adapter<BusinessHHDetailsAdapter.MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val inflater = LayoutInflater.from(context)
        val view = inflater.inflate(R.layout.business_hh_details_single_row, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (hhDetails.food == null || hhDetails.food == "") {
            holder.food_cll.visibility = View.GONE
        }
        if (hhDetails.drink == null || hhDetails.drink == "") {
            holder.drink_cll.visibility = View.GONE
        }
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var food_cll: ConstraintLayout
        var drink_cll: ConstraintLayout
        ...
        init {
            ...
            food_cll = itemView.findViewById(R.id.food_cll)
            drink_cll = itemView.findViewById(R.id.drink_cll)
        }
    }
}