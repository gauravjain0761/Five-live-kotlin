...
class ReverseHHItemsChildAdapter(var context: Context?, var categoryDataList: List<CategoryData>) :
    RecyclerView.Adapter<ReverseHHItemsChildAdapter.MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val inflater = LayoutInflater.from(context)
        val view = inflater.inflate(R.layout.reverse_hh_item_child_single_row, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.percentage_tv.text = data.percentage + "% Off"
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            percentage_tv = itemView.findViewById<View>(R.id.percentage_tv) as TextView
