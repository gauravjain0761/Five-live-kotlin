...
import com.fivelive.app.activity.happyHoursMenu.adapter.BusinessHappyHourMenuAdapter
import com.fivelive.app.util.AppConstant
import java.io.Serializable

class BusinessHhMenuFragment : Fragment() {
    var recyclerView: RecyclerView? = null
    var hhMenuArrayList: ArrayList<HHMenu>? = null
    ...
    override fun onCreateView(
        ...
        hhMenuArrayList = bundle!!.getParcelableArrayList(AppConstant.MENU_LIST)
    ...
    fun setRecipesImagesList() {
        ...
        val adapter = BusinessHappyHourMenuAdapter(
            getActivity(),
            hhMenuArrayList,
            this@BusinessHhMenuFragment
        )
