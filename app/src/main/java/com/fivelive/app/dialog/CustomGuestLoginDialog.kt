...
class CustomGuestLoginDialog(
    context: Context?,
    var alert: String,
    var message: String,
    var onButtonClicked: ()-> Unit) : Dialog(
    context!!
) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.custom_guest_login_dialog)
        window!!.setLayout(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT)
        window!!.setGravity(Gravity.CENTER_HORIZONTAL)
        okayBtn = findViewById<View>(R.id.okayBtn) as Button
        cancelBtn = findViewById<View>(R.id.cancelBtn) as Button
