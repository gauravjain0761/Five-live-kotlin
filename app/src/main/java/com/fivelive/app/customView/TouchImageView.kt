package com.fivelive.app.customView
...
class TouchImageView : androidx.appcompat.widget.AppCompatImageView, GestureDetector.OnGestureListener, OnDoubleTapListener {
    var mode = NONE
        ...
        setOnTouchListener { v, event ->
            ...
            when (event.action) {
                ...
                MotionEvent.ACTION_MOVE -> if (mode == DRAG) {
                    ...
                    fixTrans()
                    last[curr.x] = curr.y
                    if (saveScale.toDouble() == 1.0) startInterceptEvent() else stopInterceptEvent()
                }
                ...
                MotionEvent.ACTION_SCROLL -> Toast.makeText(
                    context,
                    "ACTION_SCROLL",
                    Toast.LENGTH_SHORT
                ).show()
